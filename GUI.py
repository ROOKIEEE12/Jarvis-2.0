from PyQt5.QtWidgets import QApplication, QMainWindow, QTextEdit, QWidget, QStackedWidget, QLineEdit, QGridLayout, QVBoxLayout, QHBoxLayout, QPushButton, QFrame, QLabel, QSizePolicy
